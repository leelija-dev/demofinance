...
from loan.views import ( 
    ...
    EmiCollectedAPIView, GetEmiCollectionDetailAPI, EmiLateFeeAPIView, EmiRescheduleLateFeeAPIView, AssignedEMIView, EmiCollectionByDateAPIView,
...
urlpatterns += [
    ...
    path('api/emi-by-date/', EmiCollectionByDateAPIView.as_view(), name='api_emi_by_date'),
