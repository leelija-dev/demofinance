...
COMPANY_NAME = os.environ.get('COMPANY_NAME', 'NIDHISOFT')
...
COMPANY_LOGO_TRANSPARENT = os.environ.get('COMPANY_LOGO_TRANSPARENT', 'Nidhisoft-logo.png')   
...
COMPANY_ADDRESS = os.environ.get('COMPANY_ADDRESS', 'Kolkata - 700128, West Bengal')
